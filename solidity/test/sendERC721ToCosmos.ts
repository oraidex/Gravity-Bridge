...
async function runTest(opts: {
  ...
  const { gravity, gravityERC721, testERC721, fakeGravity, checkpoint } =
...
async function getSecondERC721(
  testERC721: TestERC721A,
  gravityERC721: GravityERC721,
  ERC721NotExist?: boolean,
  ERC721NotInContract?: boolean
) {
...
async function firstCall(
  ...
  await expect(
    ...
    .to.emit(gravityERC721, "SendERC721ToCosmosEvent")
    .withArgs(
      testERC721.address,
