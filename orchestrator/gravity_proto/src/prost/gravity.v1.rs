...
impl ClaimType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ClaimType::SendErc721ToCosmos => "CLAIM_TYPE_SEND_ERC721_TO_COSMOS",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "CLAIM_TYPE_SEND_ERC721_TO_COSMOS" => Some(Self::SendErc721ToCosmos),
            _ => None,
        }
    }
}
...
/// When more than 66% of the active validator set has
/// claimed to have seen the ERC621 deposit enter the ethereum blockchain NFT is
/// minted and issued to the Cosmos address in question
/// -------------
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgSendErc721ToCosmosClaim {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
    pub eth_block_height: u64,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgSendErc721ToCosmosClaimResponse {}
/// MsgExecuteIbcAutoForwards
...
pub struct EvmChainParam {
    ...
    pub evm_chain_prefix: ::prost::alloc::string::String,
    #[prost(string, tag = "9")]
    pub bridge_erc721_ethereum_address: ::prost::alloc::string::String,
}
...
pub struct GravityNonces {
    ...
    #[prost(uint64, tag = "9")]
    pub last_erc721_observed_nonce: u64,
    #[prost(uint64, tag = "10")]
    pub last_observed_erc721_evm_block_height: u64,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
