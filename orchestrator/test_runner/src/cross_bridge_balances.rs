...
pub async fn cross_bridge_balance_test(
    ...
    let evm_chain_param = &params.evm_chain_params[0];
    ...
    create_send_to_eth_activity(
        web30,
        &evm_chain_param.evm_chain_prefix,
        grpc.clone(),
        contact,
        gravity_address,
        evm_chain_param.gravity_id.clone(),
    ...
    submit_and_pass_monitored_erc20s_proposal(
        &evm_chain_param.evm_chain_prefix,
        contact,
        keys.clone(),
