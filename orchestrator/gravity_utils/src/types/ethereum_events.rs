...
use gravity_proto::gravity::{
    MsgBatchSendToEthClaim, MsgErc20DeployedClaim, MsgLogicCallExecutedClaim,
    MsgSendErc721ToCosmosClaim, MsgSendToCosmosClaim, MsgValsetUpdatedClaim,
};
use num256::Uint256;
...
pub const MSG_SEND_ERC721_TO_COSMOS_CLAIM_TYPE_URL: &str = "/gravity.v1.MsgSendERC721ToCosmosClaim";
