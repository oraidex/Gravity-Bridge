...
GRAVITY_RELAY_ACCOUNT="minor fetch reward clean pepper agree online oppose enroll claw mimic stable around thrive lyrics deer unknown dutch fee enhance pact horse misery electric"
...
ORCHESTRATOR_MNEMONIC="file lamp sunny powder judge fatigue wool target kit mimic neck debris liar miracle crime weapon lucky tongue gorilla goose rib unique flee satisfy"
...
STARGAZE_VALIDATOR_MNEMONIC="traffic occur lens age swim tilt canvas train stairs leg base inmate vessel trigger abstract thunder whale resist summer popular nature move original tired"
STARGAZE_RELAY_ACCOUNT="result impulse book sand wedding mass top ritual swing assault claw mind outside hand kind detect gasp large radar relief wool tank taxi item"
