...
var (
	...
	pattern_Query_GetListEvmChains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gravity", "v1beta", "query_list_evm_chains"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetMonitoredERC20Addresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gravity", "v1beta", "query_monitored_token_addresses"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetBridgeBalanceSnapshots_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gravity", "v1beta", "query_bridge_balance_snapshots"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetBridgeBalanceSnapshotByEventNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gravity", "v1beta", "query_bridge_balance_snapshot_by_event_nonce"}, "", runtime.AssumeColonVerbOpt(false)))
)
