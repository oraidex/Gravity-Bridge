...
type EvmChainParam struct {
	...
	BridgeErc721EthereumAddress string `protobuf:"bytes,9,opt,name=bridge_erc721_ethereum_address,json=bridgeErc721EthereumAddress,proto3" json:"bridge_erc721_ethereum_address,omitempty"`
}
...
func (m *EvmChainParam) GetBridgeErc721EthereumAddress() string {
	if m != nil {
		return m.BridgeErc721EthereumAddress
	}
	return ""
}
...
type EvmChainData struct {
	...
	PendingErc721IbcAutoForwards []PendingERC721IbcAutoForward `protobuf:"bytes,14,rep,name=pending_erc721_ibc_auto_forwards,json=pendingErc721IbcAutoForwards,proto3" json:"pending_erc721_ibc_auto_forwards"`
}
...
func (m *EvmChainData) GetPendingErc721IbcAutoForwards() []PendingERC721IbcAutoForward {
	if m != nil {
...
type GravityNonces struct {
	...
	LastErc721ObservedNonce          uint64 `protobuf:"varint,9,opt,name=last_erc721_observed_nonce,json=lastErc721ObservedNonce,proto3" json:"last_erc721_observed_nonce,omitempty"`
	LastObservedErc721EvmBlockHeight uint64 `protobuf:"varint,10,opt,name=last_observed_erc721_evm_block_height,json=lastObservedErc721EvmBlockHeight,proto3" json:"last_observed_erc721_evm_block_height,omitempty"`
}
...
func (m *GravityNonces) GetLastErc721ObservedNonce() uint64 {
	if m != nil {
		return m.LastErc721ObservedNonce
	}
	return 0
}

func (m *GravityNonces) GetLastObservedErc721EvmBlockHeight() uint64 {
	if m != nil {
		return m.LastObservedErc721EvmBlockHeight
	}
	return 0
}
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
...
func (m *EvmChainParam) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BridgeErc721EthereumAddress) > 0 {
		i -= len(m.BridgeErc721EthereumAddress)
		copy(dAtA[i:], m.BridgeErc721EthereumAddress)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.BridgeErc721EthereumAddress)))
		i--
		dAtA[i] = 0x4a
	}
...
func (m *GravityNonces) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.LastObservedErc721EvmBlockHeight != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.LastObservedErc721EvmBlockHeight))
		i--
		dAtA[i] = 0x50
	}
	if m.LastErc721ObservedNonce != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.LastErc721ObservedNonce))
		i--
		dAtA[i] = 0x48
	}
...
func (m *EvmChainParam) Size() (n int) {
	...
	l = len(m.BridgeErc721EthereumAddress)
	if l > 0 {
		n += 1 + l + sovGenesis(uint64(l))
	}
	return n
...
func (m *GravityNonces) Size() (n int) {
	...
	if m.LastErc721ObservedNonce != 0 {
		n += 1 + sovGenesis(uint64(m.LastErc721ObservedNonce))
	}
	if m.LastObservedErc721EvmBlockHeight != 0 {
		n += 1 + sovGenesis(uint64(m.LastObservedErc721EvmBlockHeight))
	}
	return n
}
...
func (m *EvmChainParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BridgeErc721EthereumAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BridgeErc721EthereumAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenesis(dAtA[iNdEx:])
...
func (m *GravityNonces) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastErc721ObservedNonce", wireType)
			}
			m.LastErc721ObservedNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastErc721ObservedNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastObservedErc721EvmBlockHeight", wireType)
			}
			m.LastObservedErc721EvmBlockHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastObservedErc721EvmBlockHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
