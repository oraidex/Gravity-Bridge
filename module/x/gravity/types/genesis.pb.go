...
type Params struct {
	...
	SlashFractionValset          cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=slash_fraction_valset,json=slashFractionValset,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_valset"`
	SlashFractionBatch           cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=slash_fraction_batch,json=slashFractionBatch,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_batch"`
	SlashFractionLogicCall       cosmossdk_io_math.LegacyDec `protobuf:"bytes,8,opt,name=slash_fraction_logic_call,json=slashFractionLogicCall,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_logic_call"`
	...
	SlashFractionBadEthSignature cosmossdk_io_math.LegacyDec `protobuf:"bytes,10,opt,name=slash_fraction_bad_eth_signature,json=slashFractionBadEthSignature,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"slash_fraction_bad_eth_signature"`
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
