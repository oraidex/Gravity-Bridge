...
type Params struct {
	...
	BridgeErc721EthereumAddress string   `protobuf:"bytes,21,opt,name=bridge_erc721_ethereum_address,json=bridgeErc721EthereumAddress,proto3" json:"bridge_erc721_ethereum_address,omitempty"`
}
...
func (m *Params) GetBridgeErc721EthereumAddress() string {
	if m != nil {
...
type GenesisState struct {
	...
	Erc721Attestations           []Attestation                 `protobuf:"bytes,15,rep,name=erc721_attestations,json=erc721Attestations,proto3" json:"erc721_attestations"`
}
...
func (m *GenesisState) GetPendingErc721IbcAutoForwards() []PendingERC721IbcAutoForward {
	if m != nil {
...
func (m *GenesisState) GetErc721Attestations() []Attestation {
	if m != nil {
		return m.Erc721Attestations
	}
	return nil
}
...
type GravityNonces struct {
	...
	LastErc721ObservedNonce uint64 `protobuf:"varint,8,opt,name=last_erc721_observed_nonce,json=lastErc721ObservedNonce,proto3" json:"last_erc721_observed_nonce,omitempty"`
}
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Erc721Attestations) > 0 {
		for iNdEx := len(m.Erc721Attestations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Erc721Attestations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.Erc721Attestations) > 0 {
		for _, e := range m.Erc721Attestations {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc721Attestations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Erc721Attestations = append(m.Erc721Attestations, Attestation{})
			if err := m.Erc721Attestations[len(m.Erc721Attestations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
