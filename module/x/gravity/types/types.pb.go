...
type BridgeBalanceSnapshot struct {
	...
	EthereumBlockHeight uint64        `protobuf:"varint,2,opt,name=ethereum_block_height,json=ethereumBlockHeight,proto3" json:"ethereum_block_height,omitempty"`
	EvmChainPrefix      string        `protobuf:"bytes,3,opt,name=evm_chain_prefix,json=evmChainPrefix,proto3" json:"evm_chain_prefix,omitempty"`
	Balances            []*ERC20Token `protobuf:"bytes,4,rep,name=balances,proto3" json:"balances,omitempty"`
...
func (m *BridgeBalanceSnapshot) GetEvmChainPrefix() string {
	if m != nil {
...
type PendingERC721IbcAutoForward struct {
	ForeignReceiver string `protobuf:"bytes,1,opt,name=foreign_receiver,json=foreignReceiver,proto3" json:"foreign_receiver,omitempty"`
...
func (m *PendingERC721IbcAutoForward) Reset()         { *m = PendingERC721IbcAutoForward{} }
func (m *PendingERC721IbcAutoForward) String() string { return proto.CompactTextString(m) }
func (*PendingERC721IbcAutoForward) ProtoMessage()    {}
func (*PendingERC721IbcAutoForward) Descriptor() ([]byte, []int) {
	return fileDescriptor_163831c23fcc179f, []int{13}
}
func (m *PendingERC721IbcAutoForward) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PendingERC721IbcAutoForward) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PendingERC721IbcAutoForward.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PendingERC721IbcAutoForward) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PendingERC721IbcAutoForward.Merge(m, src)
}
func (m *PendingERC721IbcAutoForward) XXX_Size() int {
	return m.Size()
}
func (m *PendingERC721IbcAutoForward) XXX_DiscardUnknown() {
	xxx_messageInfo_PendingERC721IbcAutoForward.DiscardUnknown(m)
}

var xxx_messageInfo_PendingERC721IbcAutoForward proto.InternalMessageInfo

func (m *PendingERC721IbcAutoForward) GetForeignReceiver() string {
	if m != nil {
		return m.ForeignReceiver
	}
	return ""
...
func (m *PendingERC721IbcAutoForward) GetClassId() string {
	if m != nil {
		return m.ClassId
	}
	return ""
...
func (m *PendingERC721IbcAutoForward) GetTokenId() string {
	if m != nil {
		return m.TokenId
	}
	return ""
...
func (m *PendingERC721IbcAutoForward) GetIbcChannel() string {
	if m != nil {
		return m.IbcChannel
	}
	return ""
...
func (m *PendingERC721IbcAutoForward) GetEventNonce() uint64 {
	if m != nil {
		return m.EventNonce
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*PendingERC721IbcAutoForward)(nil), "gravity.v1.PendingERC721IbcAutoForward")
}
...
var fileDescriptor_163831c23fcc179f = []byte{
	...
	,
}
...
func (m *PendingERC721IbcAutoForward) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PendingERC721IbcAutoForward) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PendingERC721IbcAutoForward) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PendingERC721IbcAutoForward) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PendingERC721IbcAutoForward) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PendingERC721IbcAutoForward: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PendingERC721IbcAutoForward: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
