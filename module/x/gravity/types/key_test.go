...
func getAllKeys() [][]byte {
	...
	keys[*inc(&i)] = GetAttestationKey(GravityContractNonce, dummyPrefix, dummyNonce, dummyBytes)
	...
	keys[*inc(&i)] = GetLastEventNonceByValidatorKey(GravityContractNonce, dummyPrefix, dummyAddr)
	...
	keys[*inc(&i)] = GetPendingIbcAutoForwardKey(GravityContractNonce, dummyPrefix, dummyNonce)
