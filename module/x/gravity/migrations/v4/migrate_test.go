...
func TestMigrateParams(t *testing.T) {
	params := v3.Params{
		...
		SlashFractionValset:          sdkmath.LegacyNewDecWithPrec(5, 2),
		SlashFractionBatch:           sdkmath.LegacyNewDecWithPrec(4, 2),
		SlashFractionLogicCall:       sdkmath.LegacyNewDecWithPrec(3, 2),
		UnbondSlashingValsetsWindow:  100,
		SlashFractionBadEthSignature: sdkmath.LegacyNewDecWithPrec(2, 2),
