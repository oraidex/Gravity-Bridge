...
import (
	...
	cmtproto "github.com/cometbft/cometbft/types"
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), keyringBackend, nodeDir, inBuf, clientCtx.Codec, clientCtx.KeyringOptions...)
		if err != nil {
			return err
		}
